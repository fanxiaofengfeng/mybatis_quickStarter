...
public class MybatisTest {
    ...
    public void test1() throws IOException {
        ...
        List<User> users = sqlSession.selectList("com.amber.dao.IUserDao.findAll");
        for (User user : users) {
    ...
    public void test4() throws IOException {
        ...
        sqlSession.delete("com.amber.dao.IUserDao.deleteUser",6);
        sqlSession.commit();
